...
AR_REST = r"""
    'tourisme-senior': {
      ...
      intro:
        'مع تزايد متوسط العمر وتقدّم السكان في العمر، تشهد سياحة كبار السن نموًا قويًا. وغالبًا ما يمتلك المسافرون aged 60 عامًا فأكثر وقتًا أكبر، ويبحثون عن تجارب أصيلة ومريحة وم enriching. وبحلول 2050، يُتوقع أن يبلغ هذا الف age 2.1 مليار شخص في العالم، بينما يمثّل في أوروبا اليوم نحو ربع المسافرين الدوليين. ويجعل هذا التطور من سياحة كبار السن سوقًا استراتيجيًا يتيح فرصًا عديدة لتطوير عروض سياحية ملائمة و accessible و sustainable.',
      sections: {
...
# The above has mixed language - I need to write proper MSA. Let me write the full AR content properly in the script file instead.
