    ...
    public function run(): void
    {
        $blocks = [
            ...
            ['page' => 'home', 'section' => 'objectifs', 'key' => 'items', 'locale' => 'fr', 'type' => 'json', 'label' => 'Objectifs — Liste', 'value' => json_encode([
                ['num' => '01', 'title' => 'Vision stratégique', 'desc' => 'Apporter sa contribution en matière de vision stratégique et pratique pour la diversification et l’innovation touristique en Tunisie'],
                ['num' => '02', 'title' => 'Intérêts des membres', 'desc' => 'Sauvegarder les intérêts économiques et sociaux de ses membres'],
                ['num' => '03', 'title' => 'Synergie', 'desc' => 'Créer une synergie entre les différents opérateurs du tourisme tunisien'],
                ['num' => '04', 'title' => 'Développement', 'desc' => 'Contribuer au développement et à l’essor du tourisme tunisien'],
            ...
            ['page' => 'home', 'section' => 'groupements', 'key' => 'items', 'locale' => '_all', 'type' => 'json', 'label' => 'Groupements — Cartes', 'value' => json_encode([
                ['label' => 'Agences de voyages', 'slug' => 'agences-de-voyages', 'icon' => '/images/icon1.png'],
                ['label' => 'Hébergement alternatif', 'slug' => 'hebergements-alternatifs', 'icon' => '/images/icon2.png'],
                ['label' => 'Tourisme culturel', 'slug' => 'tourisme-culturel', 'icon' => '/images/icon3.png'],
                ['label' => 'Tourisme de santé', 'slug' => 'thalassotherapie', 'icon' => '/images/icon4.png'],
                ['label' => "Tourisme d'aventure", 'slug' => 'tourisme-aventure', 'icon' => '/images/icon5.png'],
                ['label' => "Tourisme d'affaires", 'slug' => 'tourisme-affaire', 'icon' => '/images/icon6.png'],
                ['label' => 'Tourisme écologique', 'slug' => 'tourisme-thermal', 'icon' => '/images/icon7.png'],
                ['label' => 'Tourisme aéronautique', 'slug' => 'tourisme-senior', 'icon' => '/images/icon8.png'],
                ['label' => 'Tourisme automobile', 'slug' => 'tourisme-automobile', 'icon' => '/images/icon9.png'],
                ['label' => 'Tourisme sportif', 'slug' => 'tourisme-golfique', 'icon' => '/images/icon10.png'],
                ['label' => 'Tourisme nautique', 'slug' => 'tourisme-plaisance', 'icon' => '/images/icon11.png'],
                ['label' => 'Tourisme subaquatique', 'slug' => 'tourisme-medical', 'icon' => '/images/icon12.png'],
            ], JSON_UNESCAPED_UNICODE)],
            ...
            // Qui sommes-nous
            ['page' => 'qui-sommes-nous', 'section' => 'hero', 'key' => 'image', 'locale' => '_all', 'type' => 'image', 'label' => 'Hero — Image', 'value' => '/hero.jpg'],
            ['page' => 'qui-sommes-nous', 'section' => 'hero', 'key' => 'title', 'locale' => 'fr', 'type' => 'text', 'label' => 'Hero — Titre', 'value' => 'Qui sommes-nous'],
            ...
            ['page' => 'qui-sommes-nous', 'section' => 'mission', 'key' => 'image', 'locale' => '_all', 'type' => 'image', 'label' => 'Mission — Image', 'value' => '/images/qui-sommes-nous.jpg'],
            ['page' => 'qui-sommes-nous', 'section' => 'values', 'key' => 'title', 'locale' => 'fr', 'type' => 'text', 'label' => 'Valeurs — Titre', 'value' => 'Nos objectifs'],
            ['page' => 'qui-sommes-nous', 'section' => 'values', 'key' => 'items', 'locale' => '_all', 'type' => 'json', 'label' => 'Valeurs — Grille', 'value' => json_encode([
                ['title' => 'INTÉGRITÉ', 'desc' => 'Transparence totale et éthique irréprochable au cœur de toutes nos actions institutionnelles.', 'icon' => 'shield'],
                ['title' => 'INNOVATION', 'desc' => 'Anticipation des tendances mondiales pour proposer des solutions créatives aux défis de l’industrie.', 'icon' => 'spark'],
                ['title' => 'SYNERGIE', 'desc' => 'Faire collaborer les acteurs publics et privés vers une vision de croissance partagée.', 'icon' => 'nodes'],
                ['title' => 'EXCELLENCE', 'desc' => 'Promouvoir des standards élevés et une qualité de service reconnue à l’international.', 'icon' => 'star'],
                ['title' => 'REPRESENTATION', 'desc' => 'Défendre les intérêts de l’ensemble des professionnels du tourisme tunisien.', 'icon' => 'users'],
                ['title' => 'DURABILITÉ', 'desc' => 'Encourager un tourisme responsable, inclusif et respectueux des ressources du pays.', 'icon' => 'leaf'],
            ], JSON_UNESCAPED_UNICODE)],
            ...
            ['page' => 'qui-sommes-nous', 'section' => 'diversify', 'key' => 'items', 'locale' => '_all', 'type' => 'json', 'label' => 'Diversification — Points', 'value' => json_encode([
            ...
            // Organisation
            ['page' => 'organisation', 'section' => 'hero', 'key' => 'image', 'locale' => '_all', 'type' => 'image', 'label' => 'Hero — Image', 'value' => '/hero.jpg'],
            ['page' => 'organisation', 'section' => 'hero', 'key' => 'title', 'locale' => 'fr', 'type' => 'text', 'label' => 'Hero — Titre', 'value' => 'Organisation'],
            ['page' => 'organisation', 'section' => 'stats', 'key' => 'items', 'locale' => '_all', 'type' => 'json', 'label' => 'Statistiques', 'value' => json_encode([
            ...
            ['page' => 'organisation', 'section' => 'board', 'key' => 'members', 'locale' => '_all', 'type' => 'json', 'label' => 'Bureau — Membres', 'value' => json_encode([
            ...
            ['page' => 'organisation', 'section' => 'headquarters', 'key' => 'staff', 'locale' => '_all', 'type' => 'json', 'label' => 'Siège — Équipe', 'value' => json_encode([
            ...
            ['page' => 'organisation', 'section' => 'regional', 'key' => 'title', 'locale' => 'fr', 'type' => 'text', 'label' => 'Régions — Titre', 'value' => 'Les Bureaux Régionaux'],
            ['page' => 'organisation', 'section' => 'regional', 'key' => 'map_label', 'locale' => 'fr', 'type' => 'text', 'label' => 'Régions — Label carte', 'value' => '11 Bureaux Régionaux'],
            ['page' => 'organisation', 'section' => 'regional', 'key' => 'map_image', 'locale' => '_all', 'type' => 'image', 'label' => 'Régions — Carte', 'value' => '/hero.jpg'],
            ['page' => 'organisation', 'section' => 'regional', 'key' => 'items', 'locale' => '_all', 'type' => 'json', 'label' => 'Régions — Liste', 'value' => json_encode([
            ...
            ['page' => 'organisation', 'section' => 'groupements', 'key' => 'items', 'locale' => '_all', 'type' => 'json', 'label' => 'Groupements — Cartes', 'value' => json_encode([
                ['label' => 'Agences de voyages', 'slug' => 'agences-de-voyages', 'icon' => '/images/icon1.png'],
                ['label' => 'Hébergement alternatif', 'slug' => 'hebergements-alternatifs', 'icon' => '/images/icon2.png'],
                ['label' => 'Tourisme culturel', 'slug' => 'tourisme-culturel', 'icon' => '/images/icon3.png'],
                ['label' => 'Tourisme de santé', 'slug' => 'thalassotherapie', 'icon' => '/images/icon4.png'],
            ...
            // Actualités
            ['page' => 'actualites', 'section' => 'hero', 'key' => 'image', 'locale' => '_all', 'type' => 'image', 'label' => 'Hero — Image', 'value' => '/hero.jpg'],
            ['page' => 'actualites', 'section' => 'hero', 'key' => 'title', 'locale' => 'fr', 'type' => 'text', 'label' => 'Hero — Titre', 'value' => 'Actualités'],
            ['page' => 'actualites', 'section' => 'grid', 'key' => 'per_page', 'locale' => '_all', 'type' => 'text', 'label' => 'Grille — Articles par page', 'value' => '9'],
            ['page' => 'actualites', 'section' => 'grid', 'key' => 'items', 'locale' => 'fr', 'type' => 'json', 'label' => 'Grille — Articles', 'value' => json_encode(require __DIR__ . '/data/actualites-articles.php', JSON_UNESCAPED_UNICODE)],

            // Contact
            ['page' => 'contact', 'section' => 'hero', 'key' => 'image', 'locale' => '_all', 'type' => 'image', 'label' => 'Hero — Image', 'value' => '/hero.jpg'],
            ['page' => 'contact', 'section' => 'hero', 'key' => 'title', 'locale' => 'fr', 'type' => 'text', 'label' => 'Hero — Titre', 'value' => 'Contact'],
            ['page' => 'contact', 'section' => 'info', 'key' => 'title', 'locale' => 'fr', 'type' => 'text', 'label' => 'Info — Titre', 'value' => 'Informations de contact'],
            ['page' => 'contact', 'section' => 'info', 'key' => 'address_label', 'locale' => 'fr', 'type' => 'text', 'label' => 'Info — Label adresse', 'value' => 'Adresse'],
            ['page' => 'contact', 'section' => 'info', 'key' => 'address', 'locale' => 'fr', 'type' => 'text', 'label' => 'Info — Adresse', 'value' => "Rue du Lac Turkana, Les Berges du\nLac 1\n1053 Tunis, Tunisie"],
            ['page' => 'contact', 'section' => 'info', 'key' => 'phone_label', 'locale' => 'fr', 'type' => 'text', 'label' => 'Info — Label téléphone', 'value' => 'Téléphone'],
            ['page' => 'contact', 'section' => 'info', 'key' => 'phone', 'locale' => 'fr', 'type' => 'text', 'label' => 'Info — Téléphone', 'value' => '+216 29 710 507'],
            ['page' => 'contact', 'section' => 'info', 'key' => 'email_label', 'locale' => 'fr', 'type' => 'text', 'label' => 'Info — Label email', 'value' => 'Email'],
            ['page' => 'contact', 'section' => 'info', 'key' => 'email', 'locale' => 'fr', 'type' => 'text', 'label' => 'Info — Email', 'value' => 'contact@fi2t.tn'],
            ['page' => 'contact', 'section' => 'form', 'key' => 'label_name', 'locale' => 'fr', 'type' => 'text', 'label' => 'Form — Label nom', 'value' => 'NOM COMPLET'],
            ['page' => 'contact', 'section' => 'form', 'key' => 'placeholder_name', 'locale' => 'fr', 'type' => 'text', 'label' => 'Form — Placeholder nom', 'value' => 'Nom et prénom'],
            ['page' => 'contact', 'section' => 'form', 'key' => 'label_email', 'locale' => 'fr', 'type' => 'text', 'label' => 'Form — Label email', 'value' => 'ADRESSE EMAIL'],
            ['page' => 'contact', 'section' => 'form', 'key' => 'placeholder_email', 'locale' => 'fr', 'type' => 'text', 'label' => 'Form — Placeholder email', 'value' => 'nom@exemple.com'],
            ['page' => 'contact', 'section' => 'form', 'key' => 'label_subject', 'locale' => 'fr', 'type' => 'text', 'label' => 'Form — Label sujet', 'value' => 'SUJET'],
            ['page' => 'contact', 'section' => 'form', 'key' => 'placeholder_subject', 'locale' => 'fr', 'type' => 'text', 'label' => 'Form — Placeholder sujet', 'value' => 'Ex: Demande de...'],
            ['page' => 'contact', 'section' => 'form', 'key' => 'label_message', 'locale' => 'fr', 'type' => 'text', 'label' => 'Form — Label message', 'value' => 'MESSAGE'],
            ['page' => 'contact', 'section' => 'form', 'key' => 'placeholder_message', 'locale' => 'fr', 'type' => 'text', 'label' => 'Form — Placeholder message', 'value' => 'Votre message ici...'],
            ['page' => 'contact', 'section' => 'form', 'key' => 'submit', 'locale' => 'fr', 'type' => 'text', 'label' => 'Form — Bouton', 'value' => 'Envoyer'],

            // Fiche adhésion
            ['page' => 'fiche-adhesion', 'section' => 'hero', 'key' => 'image', 'locale' => '_all', 'type' => 'image', 'label' => 'Hero — Image', 'value' => '/hero.jpg'],
            ['page' => 'fiche-adhesion', 'section' => 'hero', 'key' => 'title', 'locale' => 'fr', 'type' => 'text', 'label' => 'Hero — Titre', 'value' => 'Fiche adhésion'],
            ...
            ['page' => 'fiche-adhesion', 'section' => 'benefits', 'key' => 'title', 'locale' => 'fr', 'type' => 'text', 'label' => 'Avantages — Titre', 'value' => 'Pourquoi adhérer ?'],
            ['page' => 'fiche-adhesion', 'section' => 'benefits', 'key' => 'items', 'locale' => '_all', 'type' => 'json', 'label' => 'Avantages — Liste', 'value' => json_encode([
            ...
            ['page' => 'fiche-adhesion', 'section' => 'form', 'key' => 'title', 'locale' => 'fr', 'type' => 'text', 'label' => 'Form — Titre', 'value' => 'Demande d’adhésion'],
            ['page' => 'fiche-adhesion', 'section' => 'form', 'key' => 'label_org', 'locale' => 'fr', 'type' => 'text', 'label' => 'Form — Label raison sociale', 'value' => 'RAISON SOCIALE'],
            ['page' => 'fiche-adhesion', 'section' => 'form', 'key' => 'placeholder_org', 'locale' => 'fr', 'type' => 'text', 'label' => 'Form — Placeholder raison sociale', 'value' => 'Nom de votre structure'],
            ['page' => 'fiche-adhesion', 'section' => 'form', 'key' => 'label_contact', 'locale' => 'fr', 'type' => 'text', 'label' => 'Form — Label contact', 'value' => 'NOM DU CONTACT'],
            ['page' => 'fiche-adhesion', 'section' => 'form', 'key' => 'placeholder_contact', 'locale' => 'fr', 'type' => 'text', 'label' => 'Form — Placeholder contact', 'value' => 'Nom et prénom'],
            ['page' => 'fiche-adhesion', 'section' => 'form', 'key' => 'label_email', 'locale' => 'fr', 'type' => 'text', 'label' => 'Form — Label email', 'value' => 'ADRESSE EMAIL'],
            ['page' => 'fiche-adhesion', 'section' => 'form', 'key' => 'placeholder_email', 'locale' => 'fr', 'type' => 'text', 'label' => 'Form — Placeholder email', 'value' => 'nom@exemple.com'],
            ['page' => 'fiche-adhesion', 'section' => 'form', 'key' => 'label_phone', 'locale' => 'fr', 'type' => 'text', 'label' => 'Form — Label téléphone', 'value' => 'TÉLÉPHONE'],
            ['page' => 'fiche-adhesion', 'section' => 'form', 'key' => 'placeholder_phone', 'locale' => 'fr', 'type' => 'text', 'label' => 'Form — Placeholder téléphone', 'value' => '+216 XX XXX XXX'],
            ['page' => 'fiche-adhesion', 'section' => 'form', 'key' => 'label_activity', 'locale' => 'fr', 'type' => 'text', 'label' => 'Form — Label activité', 'value' => 'ACTIVITÉ / GROUPEMENT'],
            ['page' => 'fiche-adhesion', 'section' => 'form', 'key' => 'placeholder_activity', 'locale' => 'fr', 'type' => 'text', 'label' => 'Form — Placeholder activité', 'value' => 'Ex: Agences de voyages'],
            ['page' => 'fiche-adhesion', 'section' => 'form', 'key' => 'label_message', 'locale' => 'fr', 'type' => 'text', 'label' => 'Form — Label message', 'value' => 'MESSAGE'],
            ['page' => 'fiche-adhesion', 'section' => 'form', 'key' => 'placeholder_message', 'locale' => 'fr', 'type' => 'text', 'label' => 'Form — Placeholder message', 'value' => 'Présentez brièvement votre activité…'],
            ['page' => 'fiche-adhesion', 'section' => 'form', 'key' => 'submit', 'locale' => 'fr', 'type' => 'text', 'label' => 'Form — Bouton', 'value' => 'Envoyer la demande'],
